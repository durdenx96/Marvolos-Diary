...
/* This password protected diary uses structs, cases
 * functions, loops and pointers to perform basic journal functions, 
 * and finally posts to twitter using it's rest API. 
 * 
 *
 ****/
...
void viewrecord()
{
    ...
    int ch;
    printf("\n\n\t\t************************\n");
    printf("\t\t* VIEW RECORDS IN MARVOLO's DIARY *");
    printf("\n\t\t**************************\n\n");
    choice=password();
    if(choice!=0)
    {
    ...
    do 
    {
        printf("\n\tENTER THE TITLE OF THE RECORD TO BE VIEWED:");
        fflush(stdin);
        gets(filename);
...
void deleterecord( )
{
    ...
    while ( another == 'Y' )
    {
        ...
        printf("\n\t#DELETE A PARTICULAR RECORD BY DATE\t[2]");
        do
        {
            printf("\n\t\tENTER YOU CHOICE:");
            scanf("%d",&choice);
